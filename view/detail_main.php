...
if (!$story) {
    echo "<div class='container' style='padding:50px; text-align:center;'><h2>Truyện không tồn tại!</h2></div>";
...
<style>
    ...
    .chapter-item:hover { background: var(--bg-body); color: var(--primary); padding-left: 20px; }
    .chapter-list-box { max-height: 600px; overflow-y: auto; scrollbar-width: thin; }
    
    /* Responsive */
    @media (max-width: 768px) {
        .detail-header { flex-direction: column; }
        .detail-cover-box { width: 100%; height: auto; aspect-ratio: 2/3; margin-bottom: 20px; }
    ...
    <div class="grid-layout">
            ...
            <div class="sidebar-card shadow detail-header" style="display: flex; gap: 30px; align-items: flex-start;">
                ...
                <div style="flex: 1;">
                    ...
                    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
                        ...
                        <?php else: ?>
                            <button class="btn-write" disabled style="background: var(--border); color: var(--text-muted);">ĐANG CẬP NHẬT</button>
                        <?php endif; ?>
        ...
        <aside>
            <div class="sidebar-card shadow" style="text-align: center;">
                <img src="assets/images/<?php echo $story['author_avatar'] ?: 'default-avatar.png'; ?>" 
                ...
                <a href="me/@<?php echo $story['user_handle']; ?>" class="btn-write" style="width: 100%; display: block; font-size: 0.85rem;">Xem trang cá nhân</a>
            </div>
