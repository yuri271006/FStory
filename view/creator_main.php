...
foreach($myStories as $s) { $stat_total_chapters += $s['total_chapters']; }
?>

<main class="container" style="margin-top: 30px;">
    <div class="section-header">
        <h2 class="section-title">Studio của tôi</h2>
        ...
        <section>
            <?php if (empty($myStories)): ?>
                <div class="sidebar-card shadow" style="text-align: center; padding: 50px;">
                    ...
                    <p style="color: var(--text-muted);">Sếp chưa có tác phẩm nào. Bắt đầu viết ngay thôi!</p>
                </div>
                ...
                <div class="sidebar-card shadow" style="display: flex; gap: 20px; align-items: center; margin-bottom: 20px; transition: var(--transition);">
                    ...
                    <div style="display: flex; gap: 10px;">
                        <a href="page/creator/manage_story.php?id=<?php echo $story['id']; ?>" 
                           class="icon-btn" title="Cài đặt truyện" style="border: 1px solid var(--border);">
                        ...
                        <a href="page/creator/edit_chapter.php?story_id=<?php echo $story['id']; ?>" 
                           class="btn-write" title="Viết chương tiếp theo" style="padding: 8px 15px; font-size: 0.9rem;">
                            <i class="fa-solid fa-pen-nib"></i> <span class="hide-on-mobile">Viết tiếp</span>
                        </a>
                    </div>
                </div>
        ...
        <aside>
            <div class="sidebar-card shadow">
                <h4 style="margin-bottom: 15px; border-bottom: 1px solid var(--border); padding-bottom: 10px;">
                    <i class="fa-solid fa-chart-pie"></i> Thống kê Studio
                </h4>
                ...
                <div style="margin-top: 20px; padding: 10px; background: var(--bg-body); border-radius: 8px; font-size: 0.85rem; color: var(--text-muted); line-height: 1.5;">
                    ...
                    Mẹo: Sếp có thể kéo thả để sắp xếp lại thứ tự chương trong trang Quản lý.
                </div>
            </div>
        </aside>
    </div>
...
<style>
    @media (max-width: 768px) {
        ...
        .sidebar-card { flex-direction: column; align-items: flex-start; }
        .sidebar-card > div:first-child { width: 100% !important; height: 150px !important; }
        .sidebar-card > div:last-child { width: 100%; justify-content: space-between; margin-top: 10px; }
    }
</style>